    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), $primary url(' + pageBanner.image_url + ') center center' }">
                ...
                <div class="main_container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div v-if="description" class="margin_60" v-html="description.body"></div>
