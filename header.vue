            ...
            <div class="main_container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav id="primary_nav">
    						<ul>
    						    <li class="menu_item" v-for="item in menu_items" :id="item.id" @mouseleave="showDropDown = false">
    						        <router-link v-if="item.sub_menu == undefined" :to="item.href">{{ item.name }}</router-link>
    						        <span @click="showDropDown = !showDropDown" @mouseover="showDropDown = true" v-if="item.sub_menu != undefined">{{ item.name }}</span>
    						        <ul v-if="showDropDown" v-if="item.sub_menu">
